...
import logo from "../assets/GSA-logo.svg"
                        ...
                        <div className="usa-identifier__logos">
                            <a href="javascript:void(0);" className="usa-identifier__logo">
                                <img
                                    ...
                                    src={logo} alt="&lt;Parent agency&gt; logo"
                                    role="img"
                                />
                            </a>
                        </div>
                    ...
                    <div className="usa-identifier__container">
                        <ul className="usa-identifier__required-links-list">
                            <li className="usa-identifier__required-links-item">
                                <a href="https://www.gsa.gov/about-us" className="usa-identifier__required-link"
                                >About GSA</a
                                >
                            </li>
                            <li className="usa-identifier__required-links-item">
                                <a href="javascript:void(0);" className="usa-identifier__required-link"
