...
def test_convert_to_decimal_direct_decimal():
    output = DynamoDb._convert_to_decimal(1.2)
    assert output == Decimal("1.2")


def test_convert_to_decimal_list():
    test_input = [1.2, 2.3, 3.4]
    output = DynamoDb._convert_to_decimal(test_input)
    assert output == [Decimal("1.2"), Decimal("2.3"), Decimal("3.4")]


def test_convert_to_decimal_dict():
    test_input = {
        "a": 1.2,
        "b": 2.3,
        "c": 3.4,
...
def test_convert_to_decimal_complex():
    test_input = {
        "a": 1.2,
        "b": [
            2.3,
